...
\section{Depth of the big dipole trap}
\begin{figure}[H]
\centering
...
\begin{subfigure}[b]{0.4\textwidth}
               \includegraphics[width=\textwidth]{difshifterror}
                \caption{$D_2$-Resonance-Shift (blue) and the error boundary (red)}
\end{subfigure}
