...
\end{tabular}
\end{center}
\caption{Differential \textsc{ac}-Stark shift at 50 W of total beam power with and without magnetic field. The sensitivity to the waist-uncertainty leads to a large error and to the irrelevance of the magnetic field.}
\label{relativealpha}
\end{figure}
...
\end{align}
In this calculation $I$ is the actual maximum-intensity forming the potential and $P$ the initial power of the trap beams.
\begin{figure}[h]
\centering
