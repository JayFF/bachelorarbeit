...
The method of flourescence is pretty straigt foreward\cite{timo}. Resonant light excites the atoms, that spontaniously re-emit photons, that can be caught on camera. The disadvanage of that method 
\begin{figure}[H]
\centering
