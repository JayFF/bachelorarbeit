...
\end{align}
Taking the scattering of this number of photons, it seems possible to detect a large enough portion of it to resolve single atoms, without considering the cooling abilities of optical molasses that also have been demonstrated for Lithium \cite{sisyphus}.
